...
xtea_before_mem = 0
xtea_before_time = 0
with open("benchmark/xtea/HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
...
tldr_before_mem = 0
tldr_before_time = 0
with open("benchmark/tldr/HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
...
with open("benchmark/somrit/HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
...
for chrom in args.chroms.split(','):
    with open("benchmark/somrit/"+chrom+".Realigned_HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
        count = 0
        for line in in_file:
            if count == 0:
                count = 1
...
somrit_merge_mem = 0
somrit_merge_time = 0
with open("benchmark/somrit/Realigned_HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
...
with open("benchmark/somrit/Realigned_classified_HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
...
with open("benchmark/somrit/Realigned_classified_filtered_HG"+str(args.sample)+"_"+str(args.fraction)+"_"+str(args.rep)+".txt", 'r') as in_file:
    count = 0
    for line in in_file:
        if count == 0:
            count = 1
